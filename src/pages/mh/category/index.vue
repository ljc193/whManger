...
<template>
  ...
  <el-form :model="queryParams" ref="queryForm" :inline="true" label-width="68px">
    ...
    <el-table v-loading="loading" :data="categoryList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="分类英文名称" align="center" prop="englishName" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px">
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="分类英文名称" prop="englishName">
          <el-input v-model="form.englishName" placeholder="请输入分类英文名称" />
        </el-form-item>
...
<script>
import { listCategory,pageCategory, getCategory, delCategory, addCategory, updateCategory, exportCategory } from "@/api/mh/category";
export default {
 components: {
 	  },
  data() {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除项目分类选中的数据项?', "警告", {
