  ...
  <el-form :model="queryParams" ref="queryForm" :inline="true" label-width="68px" class='publicFprm'>
      ...
      <el-form-item label="职位名称" prop="name">
		...
		<!-- <el-form-item label="职位顺序" prop="sort">
					<el-input-number  v-model="queryParams.sort" :precision="0" :step="1" controls-position="right"></el-input-number>
				</el-form-item> -->
    ...
    <el-table v-loading="loading" :data="positionList" @selection-change="handleSelectionChange">
      ...
      <!-- <el-table-column label="职位描述" align="center" prop="content" /> -->

      <el-table-column label="职位顺序" align="center" prop="sort" />
...
<script>
import { listPosition,pagePosition, getPosition, delPosition, addPosition, updatePosition, exportPosition } from "@/api/mh/position";
 ...
 components: {
  ...
  methods: {
      ...
      this.$refs["form"].validate(valid => {
        ...
        let form = JSON.parse(JSON.stringify(this.form));
          if (form.id != undefined) {
            ...
            addPosition(form).then(response => {
              if (response.code === 200) {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除职位信息选中的数据项?', "警告", {
